...
import { 
    oneLegBenchmarkTextData, 
    calculateOneLegResult, 
    pointLevels,
    ageGroupMapping,
    reverseAgeGroupMapping,
} from '@/lib/benchmarks/one_leg';
...
function BenchmarkTable({ gender, highlightInfo }: { 
    ...
    const ageGroups = Object.keys(oneLegBenchmarkTextData[gender]);
                        ...
                        return (
                            <TableRow key={points}>
                                ...
                                {ageGroups.map(ageKey => {
                                    ...
                                    const benchmarksForAge = oneLegBenchmarkTextData[gender][ageKey as keyof typeof oneLegBenchmarkTextData.male];
...
export default function OneLegStationPage() {
